  ...
  const handleClickBuy = async (type) => {
    try {
      ...
      const {
        ...
        orderId,
        receipt,
        notes: { firstName, lastName, emailId, membershipType: returnedType },
      } = order.data;
      ...
      const options = {
        ...
        description: `${returnedType} Membership`,
        order_id: orderId,
        prefill: {
        ...
        notes: {
          membershipType: returnedType,
          receipt,
        },
        theme: { color: "#5A67D8" },
      };

      // 4. Open the Razorpay checkout dialog
